...
const Sidebar: React.FC<SidebarProps> = ({ onClose }) => {
  return (
    <div className="w-72 bg-[#272d3c] text- flex flex-col h-full">
      {/* Logo */}
      <div className="p-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-2">
            <span className="text-xl text-white font-bold">SawaCharge</span>
      ...
      <div className="px-4 mb-6">
        ...
        <ul className="space-y-2">
          <li>
            <Link href="https://www.carsawa.africa/" className="flex items-center space-x-3 text-white font-bold hover:text-white">
          ...
          <li>
            <Link href="https://blog.carsawa.africa/about" className="flex items-center space-x-3 text-white font-bold hover:text-white">
      ...
      <div className="px-4 mt-auto pb-4">
        ...
        <div className="space-y-3">
          ...
          <Link href="https://www.carsawa.africa/cars" target="_blank" rel="noopener noreferrer" className="block bg-green-500 hover:bg-green-600 text-white text-sm font-medium py-2 px-3 rounded-md transition-colors">
            <div className="text-white text-sm">BUY AN EV</div>
          </Link>
          <Link href="https://www.carsawa.africa/sell-a-car" target="_blank" rel="noopener noreferrer" className="block bg-green-500 hover:bg-green-600 text-white text-sm font-medium py-2 px-3 rounded-md transition-colors">
